<h1>Calculadora em formato de pilha</h1>
...
## A melhorar
  1 - A calculadora esta realizando apenas calculos que contenham parenteses, colchetes ou chaves, não conseguindo identificar expressões sem esses parâmetros por falta de uma identificação inicial;
  2 - O códgio não esta reconhecendo dizimas, ou seja, trabalha apenas com números simples de 0...9, sendo este um problema que foi tratado porém estava levando o código a erro de compilação;
